...
import TileIcon01 from 'assets/images/feature-tile-icon-01.svg'
import TileIcon02 from 'assets/images/feature-tile-icon-02.svg'
import TileIcon03 from 'assets/images/feature-tile-icon-03.svg'
    ...
    const features = [
        {
            ...
            title:"Join the BWA",
            description:"A pseudo-Latin text used in web design, layout, and printing inplace of things to emphasise design."
        },
        {
            imgSrc:TileIcon02,
    ...
    const listPricing = [
        {
            price:27,
            currencySymbol:"$",
            description:"Lorem ipsum its common test",
            features:[
                ...
                <Section className="pricing">
                    <div className="container">
						<div className="pricing-inner section-inner has-top-divider">
                            ...
                            <div className="tiles-wrap">
                                { listPricing.map(( list, index)=> <Cards hasShadow delayInMs={index*100}>
